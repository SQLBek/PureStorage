...
#    https://sqlbek.wordpress.com/2025/01/31/hyper-v-cluster-shared-volumes-sql-server-flasharray-snapshots/ 
#
#    https://github.com/PureStorage-OpenConnect/sqlserver-scripts/tree/master/demos-sdk2/Hyper-V%20CSV%20w%20SQL%20Server%20Snapshot
#    https://github.com/PureStorage-OpenConnect/FA-HyperV-Scripts
#
#
# Prerequisities:
...
$FlashArrayEndPoint          = 'sn1-x90r2-f06-27.puretec.purestorage.com'
$SourceVMCluster             = 'ayun-sql-fci.fsa.lab'
$SourceVMHost                = 'ayun-sql-fci-01.fsa.lab'                                
$SourceVM                    = 'ayun-hv-vm-101'                                         # No FQDN
$SourceVolumeName            = 'vvol-ayun-sql-fci-01-16c4e91c-vg/HV-SQLData-01'         # Name of the volume in FlashArray
$StagingServer               = 'ayun-sql22-02.fsa.lab'
$StagingVolumeName           = 'vvol-ayun-sql22-02-b45d7836-vg/HV-tmpSQLData-Resig'
$StagingDiskSerialNumber     = '6000c2945ce069b03b9750d2afe72828'
$TargetVMHost                = 'ayun-sql-fci-01'
$TargetVM                    = 'ayun-hv-vm-102'                                         # No FQDN
$TargetVolumeName            = 'vvol-ayun-sql-fci-02-c606c67a-vg/HV-SQLData-02'
$TargetClusterDiskNumber     = 'Cluster Disk 7'
$DatabaseName                = 'AutoDealershipDemo'
$ClusteredStorageFolder      = "C:\ClusterStorage\volume7\hv-sqldata-01\data\*.*"		# Target Host Folder containing cloned VHDX/AVHDX files 
